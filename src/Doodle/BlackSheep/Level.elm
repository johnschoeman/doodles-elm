module Doodle.BlackSheep.Level exposing (Level, allLevels, getLevel, level1, toString, updateLevels)

import Dict exposing (Dict)
import Doodle.BlackSheep.Board as Board exposing (Board, allBoards)
